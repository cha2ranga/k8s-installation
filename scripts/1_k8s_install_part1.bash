...
yum install yum-utils device-mapper-persistent-data lvm2 tree screen wget elinks device-mapper-multipath iscsi-initiator-utils iscsi-initiator-utils-devel git bash-completion nfs-utils -y
